...
<div class="warning-header" style="text-align: center; flex: 1;">
    <h2 style="margin: 0; font-weight: normal; line-height: 1.2; white-space: nowrap;">
        <span style="color: red;">THIS INVOICE IS INSURED BY &nbsp;&nbsp;</span><img
            src="{{ public_path('images/allianz-logo.svg') }}" alt="Allianz Logo"
            style="height: 1.15em; vertical-align: -0.2em;"><span style="color: red;">COMPANY. PLEASE PAY ON TIME TO AVOID LAW<br>PROBLEMS AND DECREASING YOUR RATING.</span>
    </h2>
</div>
...
<div class="invoice-title-section">
    ...
    <span class="invoice-number">500202503</span>
</div>
